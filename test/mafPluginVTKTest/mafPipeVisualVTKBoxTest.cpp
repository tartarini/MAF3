...
/**
 Class name: mafPipeVisualVTKBoxTest
 This class creates a vtkPolyData and visualizes it trough the mafPipeVisualVTKBox
 */
class mafPipeVisualVTKBoxTest : public QObject {
    Q_OBJECT
...
private Q_SLOTS:
    ...
    void initTestCase() {
        ...
        m_VisualPipeSelection = mafNEW(mafPluginVTK::mafPipeVisualVTKBox);
    ...
    /// Allocation test for the mafPipeVisualVTKBox.
    void allocationTest();
...
private:
    mafPipeVisualVTKBox *m_VisualPipeSelection; ///< Test variable.
...
void mafPipeVisualVTKBoxTest::initializeGraphicResources() {
    w = new QMainWindow();
    w->setMinimumSize(640,480);
    w->setWindowTitle("mafPipeVisualVTKBox Test");
...
void mafPipeVisualVTKBoxTest::shutdownGraphicResources() {
    w->close();
}

void mafPipeVisualVTKBoxTest::allocationTest() {
    QVERIFY(m_VisualPipeSelection != NULL);
    QVERIFY(mafPipeVisualVTKBox::acceptObject(m_VME));
    m_VisualPipeSelection->setInput(m_VME);
}

void mafPipeVisualVTKBoxTest::createPipeTest() {
...
void mafPipeVisualVTKBoxTest::updatePipeTest() {
...
MAF_REGISTER_TEST(mafPipeVisualVTKBoxTest);
#include "mafPipeVisualVTKBoxTest.moc"
