...
#include <mafQAManager.h>
    ...
    #define TEST_SCRIPT_NAME "../../../trunk/mafQA/mafQATest/AppExample.bat"
#else
    #ifdef __APPLE__
        #define TEST_LIBRARY_NAME "libmafPluginTest_debug.dylib"
        #define TEST_SCRIPT_NAME "../../../trunk/mafQA/mafQATest/AppExample"
    #else
        #define TEST_LIBRARY_NAME "libmafPluginTest_debug.so"
        #define TEST_SCRIPT_NAME "../../../trunk/mafQA/mafQATest/AppExample.sh"
    #endif
#endif
...
void mafQAManagerTest::runPythonScriptTest() {
    ...
    int res = m_QAManager->runPythonScript("../../../trunk/mafQA/scriptsQA/GeneratorQA.py",argList);
    QVERIFY(res == 0);

    //launch sync
    mafMsgDebug() << "Synchronous:";
    res = m_QAManager->runPythonScript("../../../trunk/mafQA/scriptsQA/GeneratorQA.py",argList, true);
    QVERIFY(res == 0);
}
