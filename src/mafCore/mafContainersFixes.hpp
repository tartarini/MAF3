#ifndef MAFCORE_CONTAINERS_FIXES
#define MAFCORE_CONTAINERS_FIXES
////////////////////////////////////////////////////////////////////////////////
...
//      e.g. return typename mafTree<T>::const_iterator(this,m_root);
//                  ^^^^^^^^
//   5) Creating temporary objects when passing arguments to a function or constructor
//      e.g. return typename mafTree<T>::const_prefix_iterator(typename mafTree<T>::const_iterator(this,m_root));
//                                                           ^^^^^^^^
...
#define MAFCORE_MEMBER_TEMPLATES

// Visual Studio v6 (compiler version 12) does not support them
#ifdef _MSC_VER
#if _MSC_VER <= 1200
#undef MAFCORE_MEMBER_TEMPLATES
#endif
#endif
