...
import math
import Executer
from Rules.ClassStructureRules import ProtectedDestructorRule

class ClassStructureRulesQA():
    def __init__(self):
    ...
    def ProtectedDestructorRule(self, dirPath, file):
        rule = ProtectedDestructorRule.ProtectedDestructorRule()
    ...
    def CheckSources(self,baseDirectory, outputDirectoryCheck, ruleMethod):
        ...
        self.FileOutput.write("Check that Class Structures follow basic MAF guidelines" + "\n")
        self.FileOutput.write("</ruleDescription>\n")
...
if __name__ == '__main__':
    if len(sys.argv) != 3:
        ...
        nc = ClassStructureRulesQA()
        nc.SetFilePattern("\Aclass.*\.xml")
        nc.CheckSources(sys.argv[1],  sys.argv[2],"ProtectedDestructorRule")
