...
import math
import Executer
from Rules.CoverageRules import CoverageTestRule

class CoverageRulesQA():
    def __init__(self):
    ...
    def CoverageTestRule(self, dirPath, file):
        rule = CoverageTestRule.CoverageTestRule()
        rule.setRuleParameters(".*Test$")
    ...
    def CheckSources(self,baseDirectory, outputDirectoryCheck, ruleMethod):
        ...
        self.FileOutput.write("Check which are the tests present inside the framework" + "\n")
        self.FileOutput.write("</ruleDescription>\n")
...
if __name__ == '__main__':
    if len(sys.argv) != 3:
        ...
        nc.CheckSources(sys.argv[1],  sys.argv[2],"CoverageTestRule")
