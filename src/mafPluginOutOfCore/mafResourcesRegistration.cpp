...
void mafResourcesRegistration::registerResourcesObjects() {
    ...
    mafRegisterObject(mafResources::mafVolume);
    ...
    mafRegisterObject(mafResources::mafMementoVolume);
...
void mafResourcesRegistration::unregisterResourcesObjects() {
    ...
    mafUnregisterObject(mafResources::mafVolume);
    ...
    mafUnregisterObject(mafResources::mafMementoVolume);
